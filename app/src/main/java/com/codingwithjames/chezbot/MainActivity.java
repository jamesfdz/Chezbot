...
//        mimicOtherMessage("HelloWorld");
    ...
    private void mimicOtherMessage(String helloWorld) {
        ChatMessage chatMessage = new ChatMessage(false, false, helloWorld);
        mAdapter.add(chatMessage);
    }

    private void sendMessage() {
        ChatMessage chatMessage = new ChatMessage(true, true, null);
        mAdapter.add(chatMessage);
    ...
    private void mimicOtherMessage() {
        ChatMessage chatMessage = new ChatMessage(true, false, null);
        mAdapter.add(chatMessage);
    }
}
